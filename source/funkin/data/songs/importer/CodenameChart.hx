...
typedef CNEChartMetaData = {
	...
	public var ?metas:Map<String, CNEChartMetaData>;
	public var ?instSuffix:String;
	public var ?vocalsSuffix:String;
	public var ?needsVoices:Bool;
}

typedef CNEChartStrumLine = {
	var characters:Array<String>;
	var type:CNEChartStrumLineType;
	var notes:Array<CNEChartNote>;
	var position:String;
...
enum abstract CNEChartStrumLineType(Int) from Int to Int {
	/**
